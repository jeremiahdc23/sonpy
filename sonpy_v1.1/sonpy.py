...
class sonnet(object):
    ...
    def cropBox(self, xcellsize=1, ycellsize=1):
        ...
        self.project.geo.box.xwidth = xmax - xmin
        self.project.geo.box.ywidth = ymax - ymin
    ...
    def addBrick(self, erel=1, loss_tan=0, cond=0, name="Air"):
        ...
        :param float or list len 3 of floats erel: relative permitivity or [erelx, erely, erelz]
        :param float or list len 3 of floats loss_tan: loss tangent or [erelx, erely, erelz]
        :param falot or list len 3 of floats cond: conductivity or [erelx, erely, erelz]
        """
